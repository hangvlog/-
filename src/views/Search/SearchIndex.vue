    ...
    <div class="main">
      <div class="py-container">
        ...
        <SearchSelector @trademarkInfo="trademarkInfo"
                        @attrInfo="attrInfo"></SearchSelector>
              ...
              <li class="yui3-u-1-5"
                ...
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a target="_blank"
                       href="item.html"
                       title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{ goodsList.title }}</a>
                  </div>
                  <div class="commit">
...
export default {
  ...
  methods: {
    ...
    removeKeyword () {
      ...
      // 通知兄弟组件清楚关键字
      this.$bus.$emit('removeKeyword', this.searchParams)
      this.$router.push({
        name: 'search',
    ...
    attrInfo (attrs, attrsValue) {
      let item = `${attrs.attrId}:${attrsValue}:${attrs.attrName}`
