    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix"
          ...
          <li>
            <h3>{{item.skuNum * item.orderPrice}}</h3>
          </li>
          <li>X{{item.skuNum}}</li>
          <li>有货</li>
        </ul>
...
export default {
  ...
  methods: {
    changeDefault (user) {
      ...
      console.log('isDefault changeDefault')
    },
    async submitInfo () {
  ...
  computed: {
    // cartInfoList () {
    //   return this.$store.state.shopCar.cartList ? this.$store.state.shopCar.cartList[0].cartInfoList : [];
    // }
    ...mapState({
